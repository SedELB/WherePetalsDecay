...
export const IMPACT_POPUP_DURATION_MS = 1300;
...
export const DICE_RESULT_DISPLAY_MS = 3000;
export const ROUND_PHASE_DELAY_MS = 500;
export const DAMAGE_POPUP_DURATION_MS = 3000;
export const ROUND_ANNOUNCEMENT_DURATION_MS = 2000;
export const FIGHTER_MOVEMENT_DURATION_MS = 1000;
export const FIGHTER_IMPACT_DELAY_MS = 500;
