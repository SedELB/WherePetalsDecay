...
export const COMBAT_START_ANNOUNCEMENT_DELAY_MS = 4000;
export const COMBAT_POSTURE_TIMEOUT_MS = 10000;
export const COMBAT_POSTURE_COUNTDOWN_START_DELAY_MS = 2000;

export const COMBAT_START_POPUP_DISPLAY_DURATION_MS = 4000;
export const COMBAT_END_POPUP_DISPLAY_DURATION_MS = 4000;

export const POSTURE_RESULT_DISPLAY_DURATION_MS = 4000;
export const ROUND_PHASE_BUFFER_MS = 1000;
export const DICE_ROLL_DURATION_MS = 4000;
export const DICE_RESULT_DISPLAY_DURATION_MS = 3000;
export const DAMAGE_DISPLAY_DURATION_MS = 3000;
export const FIGHTER_ADVANCE_DURATION_MS = 1000;
export const FIGHTER_HOLD_DURATION_MS = 500;
export const FIGHTER_RETREAT_DURATION_MS = 1000;
export const STATUS_BUFFER_DURATION_MS = 4000;
