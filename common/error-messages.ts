...
export const HEALING_SANCTUARIES_NOT_PLACED = 'Le nombre de sanctuaires de soin dépasse le maximum autorisé !';
export const COMBAT_SANCTUARIES_NOT_PLACED = 'Le nombre de sanctuaires de combat dépasse le maximum autorisé !';
