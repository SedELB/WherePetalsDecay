...
describe('GameValidator', () => {
    ...
    it('countByProperty() should return the correct property count for types', () => {
        ...
        const result = (gameValidatorService as any).countByProperty(getValidGame(), 'type');
    ...
    it('countByProperty() should return the correct property count for items', () => {
        ...
        const result = (gameValidatorService as any).countByProperty(getValidGame(), 'item');
    ...
    it('isTextLengthValid() should return true if the game name and desc are valid', () => {
        ...
        expect((gameValidatorService as any).isTextLengthValid(getValidGame())).toEqual(true);
    });
    ...
    it('isTextLengthValid() should fail if the game name is empty', () => {
        ...
        expect(() => (gameValidatorService as any).isTextLengthValid(emptyNameGame)).toThrow(NAME_FIELD_EMPTY);
    });
    ...
    it('isTextLengthValid() should fail if the game name exceeds max length', () => {
        ...
        expect(() => (gameValidatorService as any).isTextLengthValid(longNameGame)).toThrow(NAME_FIELD_TOO_LONG);
    });
    ...
    it('isTextLengthValid() should fail if the game desc is empty', () => {
        ...
        expect(() => (gameValidatorService as any).isTextLengthValid(emptyDescGame)).toThrow(DESCRIPTION_FIELD_EMPTY);
    });
    ...
    it('isTextLengthValid() should fail if the game desc is exceeds max length', () => {
        ...
        expect(() => (gameValidatorService as any).isTextLengthValid(longDescGame)).toThrow(DESCRIPTION_FIELD_TOO_LONG);
    });
    ...
    it('isTextLengthValid() should fail with multiple errors', () => {
        ...
        expect(() => (gameValidatorService as any).isTextLengthValid(badGame)).toThrow();
    });
    ...
    it('isGameSurfaceValid() should return true if there is more than 50% walkable tiles', () => {
        ...
        const spyCountByProperty = jest.spyOn(gameValidatorService as any, 'countByProperty');
        expect((gameValidatorService as any).isGameSurfaceValid(getValidGame())).toEqual(true);
    ...
    it('isGameSurfaceValid() should fail if less than 50% walkable', () => {
        ...
        expect(() => (gameValidatorService as any).isGameSurfaceValid(game)).toThrow(INSUFFICIENT_TERRAIN_TILES);
    });
    ...
    it('areAllSpawnPointsPlaced() should return true if all spawn points are placed', () => {
        ...
        const spyCountByProperty = jest.spyOn(gameValidatorService as any, 'countByProperty');
        expect((gameValidatorService as any).areAllSpawnPointsPlaced(getValidGame())).toEqual(true);
    ...
    it('areAllSpawnPointsPlaced() should fail if not all spawns are placed', () => {
        ...
        expect(() => (gameValidatorService as any).areAllSpawnPointsPlaced(invalidGame)).toThrow(SPAWN_POINTS_NOT_PLACED);
    });

    it('findFirstWalkableTile() should return the first walkable tile', () => {
        // Locates starting position for pathfinding algorithm
        expect((gameValidatorService as any).findFirstWalkableTile(getValidGame().grid)).toMatchObject({ y: 0, x: 2 });
    });

    it('findFirstWalkableTile() should return null if there is no walkable tile', () => {
        // Returns null when map has no accessible tiles
        expect((gameValidatorService as any).findFirstWalkableTile(invalidGame.grid)).toEqual(null);
    });

    it('getObjectsPositions() should return all door positions', () => {
        // Retrieves coordinates of all doors on map
        const positions = (gameValidatorService as any).getObjectsPositions(getValidGame(), 'door');
    ...
    it('getObjectsPositions() should return spawn positions', () => {
        ...
        const positions = (gameValidatorService as any).getObjectsPositions(getValidGame(), TileItem.Spawn);
    ...
    it('getObjectsPositions() should return empty array for empty grid', () => {
        ...
        expect((gameValidatorService as any).getObjectsPositions(emptyGame, 'door')).toEqual([]);
    });
    ...
    it('getObjectsPositions() should return empty array when object not found', () => {
        ...
        const positions = (gameValidatorService as any).getObjectsPositions(getCleanGame(), 'door');
    ...
    it('isTileValidForPath() should return true if tile isnt surrounded by walls', () => {
        ...
        expect((gameValidatorService as any).isTileValidForPath(getValidGame(), 0, 2, visited)).toEqual(true);
    });
    ...
    it('isTileValidForPath() should return false if tile is surrounded by walls', () => {
        ...
        const visited = new Set<string>();
        expect((gameValidatorService as any).isTileValidForPath(game, 0, 0, visited)).toEqual(false);
    });
    ...
    it('isTileValidForPath() should return false for a tile out of bounds', () => {
        ...
        const game = getValidGame();
        const visited = new Set<string>();
        expect((gameValidatorService as any).isTileValidForPath(game, -1, 0, visited)).toEqual(false);
        expect((gameValidatorService as any).isTileValidForPath(game, BASE_10, 0, visited)).toEqual(false);
        expect((gameValidatorService as any).isTileValidForPath(game, 0, BASE_10, visited)).toEqual(false);
    });
    ...
    it('areThereUnreachableTiles() should return true if all tiles are reachable', () => {
        ...
        const spyFindFirstWalkableTile = jest.spyOn(gameValidatorService as any, 'findFirstWalkableTile');
        const spyCountByProperty = jest.spyOn(gameValidatorService as any, 'countByProperty');
        expect((gameValidatorService as any).areThereUnreachableTiles(getValidGame())).toEqual(true);
    ...
    it('areThereUnreachableTiles() should fail if there are no walkable tiles', () => {
        ...
        expect(() => (gameValidatorService as any).areThereUnreachableTiles(invalidGame)).toThrow(NO_TERRAIN_TILES);
    });
    ...
    it('areThereUnreachableTiles() should fail if there are unreachable tiles', () => {
        ...
        expect(() => (gameValidatorService as any).areThereUnreachableTiles(game)).toThrow(UNREACHABLE_TILES);
    });
    ...
    it('isDoorsPlacementValid() should return true for valid vertical door', () => {
        ...
        expect((gameValidatorService as any).isDoorsPlacementValid(game)).toEqual(true);
    });
    ...
    it('isDoorsPlacementValid() should throw for door on border', () => {
        ...
        expect(() => (gameValidatorService as any).isDoorsPlacementValid(game)).toThrow();
    });
    ...
    it('isDoorsPlacementValid() should return true if no doors', () => {
        ...
        const game = getCleanGame();
        const spyGetObjectsPositions = jest.spyOn(gameValidatorService as any, 'getObjectsPositions');
        expect((gameValidatorService as any).isDoorsPlacementValid(game)).toEqual(true);
    ...
    it('isDoorOnGridBorder() should return true for door inside grid', () => {
        ...
        expect((gameValidatorService as any).isDoorOnGridBorder(getValidGame().grid, BASE_5, BASE_5)).toEqual(true);
    });

    it('isDoorOnGridBorder() should return false for door on top border', () => {
        // Detects doors on the top edge (row index 0) of the grid
        expect((gameValidatorService as any).isDoorOnGridBorder(getValidGame().grid, 0, BASE_5)).toEqual(false);
    });
    ...
    it('isDoorOnGridBorder() should return false for door on bottom border', () => {
        ...
        expect((gameValidatorService as any).isDoorOnGridBorder(getValidGame().grid, BASE_10 - 1, BASE_5)).toEqual(false);
    });
    ...
    it('isDoorOnGridBorder() should return false for door on left border', () => {
        ...
        expect((gameValidatorService as any).isDoorOnGridBorder(getValidGame().grid, BASE_5, 0)).toEqual(false);
    });
    ...
    it('isDoorOnGridBorder() should return false for door on right border', () => {
        ...
        expect((gameValidatorService as any).isDoorOnGridBorder(getValidGame().grid, BASE_5, BASE_10 - 1)).toEqual(false);
    });
    ...
    it('isFlagPlaced() should return true if flag is placed on CTF gamemode', () => {
        ...
        expect((gameValidatorService as any).isFlagPlaced(game)).toEqual(true);
    });

    it('isFlagPlaced() should return false if gamemode is Classic', () => {
        // Skips flag validation for Classic game mode (flags not required)
        const game = getCleanGame();
        expect((gameValidatorService as any).isFlagPlaced(game)).toEqual(false);
    });
    ...
    it('isFlagPlaced() should fail if flag is not placed in CTF', () => {
        ...
        game.gameMode = GameMode.Ctf;
        const spyCountByProperty = jest.spyOn(gameValidatorService as any, 'countByProperty');
        expect(() => (gameValidatorService as any).isFlagPlaced(game)).toThrow(FLAG_NOT_PLACED);
    ...
    it('isGameValid() should return true for a valid game', () => {
        ...
        const spyIsTextLengthValid = jest.spyOn(gameValidatorService as any, 'isTextLengthValid');
        const spyIsDoorsPlacementValid = jest.spyOn(gameValidatorService as any, 'isDoorsPlacementValid');
        const spyAreThereUnreachableTiles = jest.spyOn(gameValidatorService as any, 'areThereUnreachableTiles');
        const spyIsGameSurfaceValid = jest.spyOn(gameValidatorService as any, 'isGameSurfaceValid');
        const spyAreAllSpawnPointsPlaced = jest.spyOn(gameValidatorService as any, 'areAllSpawnPointsPlaced');
        const spyIsFlagPlaced = jest.spyOn(gameValidatorService as any, 'isFlagPlaced');
