...
import { TEXT_MIN_LENGTH, NAME_MAX_LENGTH, DESC_MAX_LENGHT, MIN_PLAYERS, MAX_PLAYERS } from '@app/utils/game.constants';
...
export class Game {
    ...
    @Prop({ required: true, trim: true, min: TEXT_MIN_LENGTH, max: DESC_MAX_LENGHT })
    description: string;
